...
import com.garrett.CompareLTOperation;
import com.garrett.PushOperation;
import com.garrett.SymbolTable;

class CompareLTOperationTest {

	/**
	 * Tests if constructing operation is dont correctly.
	 */
	@Test
	void testCompareLTOperation() {
		assertNotNull(new CompareLTOperation());
	}
	...
	void testTrueComparison() {
		...
		/* Check if true */
		CompareLTOperation compareLT = new CompareLTOperation();
		compareLT.execute(0, stack, symbols);
